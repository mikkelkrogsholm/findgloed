...
| 3 | Lag 2 (match) skal virke | `epic/pakke-3-match-layer` | 🟢 DONE | done | A2, B1, B2, B48 — match-relation aktiv, incoming-interests-side, private album grant UI, 64/64 tests grønne |
