...
| 6 | Code of conduct + terms | `epic/pakke-6-coc-terms` | 🟢 DONE | done | A5, B46 — CoC m. 3-level tabs + URL-hash, terms-side m. 14-dages fortrydelse + 30-dages varsel, global footer, signup/landing/event-detail links, 59/59 tests grønne |
